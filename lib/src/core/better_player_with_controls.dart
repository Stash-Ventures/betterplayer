...
class _BetterPlayerWithControlsState extends State<BetterPlayerWithControls> {
  ...
  Widget build(BuildContext context) {
    ...
    aspectRatio ??= 16 / 9;
    final innerContainer = LayoutBuilder(
  ...
  Container _buildPlayerWithControls(BetterPlayerController betterPlayerController, BuildContext context, double aspectRatio) {
